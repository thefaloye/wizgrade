...
$productCategoryData =<<<IGWEZE
									...
									<tr id="row-$pID" ><td class='text-left' width="5%">$serailNo</td> 
										<td class='text-left' width="80%"> $productCategory </td> 
										...
										<div class="btn-group">
											...
											<i class="fa fa-wrench"></i> <span class="caret"></span></button>
												<ul role="menu" class="dropdown-menu pull-right">
														<li>
														<a href='javascript:;' id='$pID' class ='editProductCategory'>
														<button class="btn btn-success btn-xs"><i class="fa fa-edit"></i></button> Edit</a>
														</li>
														<li class="divider"></li>
														<li>
														<a href='javascript:;' id='wizGrade-$pID-$productCategory' class ='removeProductCategory'> 
