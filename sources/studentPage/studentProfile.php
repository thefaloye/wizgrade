					...
					<div class="col-md-12">
                      <section class="panel">
                          <header class="panel-heading">
                             <i class="fa fa-user-plus fa-lg"></i> Student Profile Manager
...
$table =<<<IGWEZE
						...
						$date</td> </tr>
						<tr><th style="padding-left: 30px !important; text-align:left; width: 30%;">
						<i class="fa fa-flag"></i> Country/Nationality </td> <td style="padding-left: 30px !important; text-align:left; width: 70%;">
						$country</td> </tr>
						<tr><th style="padding-left: 30px !important; text-align:left; width: 30%;">
						<i class="fa fa-home"></i> State/Province </td> <td style="padding-left: 30px !important; text-align:left; width: 70%;">
						$state</td> </tr>
						<!--
						<tr><th style="padding-left: 30px !important; text-align:left; width: 30%;">
...
?>
			...
			<script type='text/javascript'> $('.wizGradePageIcons').fadeIn(200); $('.slideIcon').fadeOut(5); $('.printerIcon').fadeIn(200); 	 </script>