...
$table_head =<<<IGWEZE
			...
			<th colspan = "6" style="background-color:#fff !important;">  
				...
				<div class='col-lg-12'>
					...
					<img src="$sch_logo" height='70' width = '90' id='wizGradeStudentPica' class='img-rounded'/>
					</div>
...
$table_body =<<<IGWEZE
			...
			<!-- table -->
			<table width="100%" border="0"   class="displaya compacta table-bordered  
			...
			<th style='text-align:left; padding-left:10px;'>Subject <br />  Teacher's <br /> Remark</th>
...
$table_foot =<<<IGWEZE
				...
				<!-- table -->
				<table width="100%" border="0" style="border-color:#fff; margin-top: 0px; font-size:14px;" align="center" class="display table table-bordered table-striped">
				  
				<tr style="border-color:#fff;">
					<td width="50%"  style="text-align:left; padding: 5px; border-color:#fff; font-weight:bold; border-bottom-color:#000;">Student's Annual Total Score : 
					<span class="tb-caption"> $annualTotal </span></td>
					<td width="50%" style="text-align:left; padding: 5px; border-color:#fff; font-weight:bold; border-bottom-color:#000;">Student's Annual Average: 
				...
				<tr style="border-color:#fff;">
					...
					<td width="50%" style="text-align:left; padding: 5px; border-color:#fff; font-weight:bold; border-bottom-color:#000;">Annual Position in Class : 
