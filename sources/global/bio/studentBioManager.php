		 			...
		 			try {
							...
							$ebele_mark = "UPDATE $i_student_tb SET
								...
								if ($igweze_prep->execute()) {
										...
										$msg_s = "Student Profile with
										<span>$pre_regnum $regNum
										</span>Profile Data  Step 2 was Successfully Saved.";
                    ...
                    Thanks ";
		 			...
		 			try { 
							...
							if ($igweze_prep->execute()) {
								...
								$msg_s = "Student Profile with
								<span>$pre_regnum $regNum
								</span>Profile Data Step 3 was Successfully Saved.";
                    ...
                    Thanks ";
		 			...
		 			try {
							...
							if ($igweze_prep->execute()) {  /* if sucessfully */
								...
								$msg_s = "Student Profile with
								<span>$pre_regnum $regNum
								</span>Sponsor Data was Successfully Saved.";
      			...
      			if ($regNum == "")  {
					...
					try {
							...
							if ($igweze_prep->execute()) {  /* if sucessfully */
									...
									$msg_s = "Student Profile with
									<span>$pre_regnum $regNum
									</span> Class Infomation was Successfully Saved";
						...
						$c_session_fi - $c_session_se session";
								...
								$session_frm = $sessionID;							
									...
									if ($igweze_prep->execute()) {
											...
											$msg_s = "Student Profile with
											<span>$pre_regnum $regNum
											</span>result session was Successfully move to $session - $session_se session.";
