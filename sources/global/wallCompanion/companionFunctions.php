				...
				if($rows_count_1 >= $foreal) {
					...
					while($row = $igweze_prep_1->fetch(PDO::FETCH_ASSOC)) {		
								...
								$fi_upload = '
								  ...
								  <li>
									  <figure>
										 ...
										 <img src="'.$forumPicExt.$post_img_fi.'" alt="'.$post_img_fi.'" style="height:180px; width 100px; border-radius:8px;"/>
										  <figcaption>
								...
								$se_upload = '
									  ...
									  <li>
										  <figure>
											 ...
											 <img src="'.$forumPicExt.$post_img_se.'" alt="'.$post_img_se.'" style="height:180px; width 100px; border-radius:8px;"/>
											  <figcaption>
								...
								$th_upload = '
									  ...
									  <li>
										  <figure>
											 ...
											 <img src="'.$forumPicExt.$post_img_th.'" alt="'.$post_img_th.'" style="height:180px; width 100px; border-radius:8px;" />
											  <figcaption>
								...
								$fo_upload = '
									  ...
									  <li>
										  <figure>
											 ...
											 <img src="'.$forumPicExt.$post_img_fo.'" alt="'.$post_img_fo.'" style="height:180px; width 100px; border-radius:8px;" />
											  <figcaption>
						...
						if(($checkPostAuthor == true) ){ //|| ($_SESSION['wallComRank'] == $seVal)
							...
							class="sendMailPosts fb-time-action-like"> <i class="fa fa-envelope"></i> <strong> Send Message 
							</strong></a>
							
							<span>-</span> <a href="javascript:;" title="Report User" id="sendReportPosts-'.$post_id.'-'.$author_id.'" 
							class="sendReportPosts fb-time-action-like"> <i class="fa fa-comments"></i> <strong> Report User 
							</strong></a>
				...
				if($rows_count_1 >= $foreal) {
					...
					while($row = $igweze_prep_1->fetch(PDO::FETCH_ASSOC)) {		
								...
								$fi_upload = '
								  ...
								  <li>
									  <figure>
										 ...
										 <img src='.$forumPicExt.$post_img_fi.' Class ="uploadPicDi" style="height:180px; width 100px; border-radius:8px;" />
										  <figcaption>
								...
								$se_upload = '
								  ...
								  <li>
									  <figure>
										 ...
										 <img src='.$forumPicExt.$post_img_se.' Class ="uploadPicDi" style="height:180px; width 100px; border-radius:8px;" />
										  <figcaption>
								...
								$th_upload = '
								  ...
								  <li>
									  <figure>
										 ...
										 <img src='.$forumPicExt.$post_img_th.' Class ="uploadPicDi" style="height:180px; width 100px; border-radius:8px;" />
										  <figcaption>
								...
								$fo_upload = '
								  ...
								  <li>
									  <figure>
										 ...
										 <img src='.$forumPicExt.$post_img_fo.' Class ="uploadPicDi" style="height:180px; width 100px; border-radius:8px;" />
										  <figcaption>
						...
						if (($this_user_id == $author_id) && ($faRegNum_this == $faRegNum)) {
							...
							$showMailReportBox = '<span>-</span> <a href="javascript:;" title="Send Message" 
							id="sendMailPosts-'.$post_id.'-'.$author_id.'" 
							class="sendMailPosts fb-time-action-like"> <i class="fa fa-envelope"></i> <strong> Send Message </strong></a>
							
							<span>-</span> <a href="javascript:;" title="Report User" id="sendReportPosts-'.$post_id.'-'.$author_id.'" 
							class="sendReportPosts fb-time-action-like"> <i class="fa fa-comments"></i> <strong> Report User </strong></a>
							<span id="mailReportPostsMsg_'.$post_id.'"></span> <span id="mailReportPostsDiv_'.$post_id.'"> </span>';
...
IGWEZE;
			...
			function companionWallComments($conn, $post_id) {  /* load companion wall post comment */
					...
					$stuPicUser = '<img src="'.$stuUserpic.'" class="poster-img" />';
					...
					if($rows_count >= $foreal) {
						...
						while($row = $igweze_prep->fetch(PDO::FETCH_ASSOC)) {		
							...
							if($this_user_id == $comment_user) {
								...
								class="sendMailComments fb-time-action-like"> <i class="fa fa-envelope"></i> <strong> Send Message </strong></a>
								
								
								<span>-</span> <a href="javascript:;" title="Report User" 
								id="sendReportComments-'.$post_id.'-'.$comment_id.'-'.$comment_user.'" 
								class="sendReportComments fb-time-action-like"> <i class="fa fa-comments"></i> <strong> Report User </strong></a>
							...
							$stuPic = '<img src="'.$stuFpic.'" class="comment-img" />';
...
$comment_body =<<<IGWEZE
		...
		<div id="newCommentDiv-$post_id"></div>				
			 ...
			 <li>
                <a href="javascript:;" class="cmt-thumb showcompanionWallUser" id="companionWallUser-$this_user_id">
                   $stuPicUser
                 </a>
                 <div class="cmt-form">
...
IGWEZE;
			...
			function commentsNum($conn, $post_id) {  /* count number post comments */
					...
					if($rows_count == 0){ $commment = "<i class='fa fa-comment-o'></i> <strong>No Comment Yet</strong> ";}
					elseif($rows_count == 1){ $commment = "<i class='fa fa-comment-o'></i>  1<strong>   Comment </strong> ";}				
					elseif($rows_count >= 2){ $commment = "<i class='fa fa-comment-o'></i> $rows_count <strong> Comments </strong>";}
					else{$commment = "<i class='fa fa-comment-o'></i> No <strong> Comment </strong>";}			
					...
					try {
						...
						list ($senderID, $faRegNum, $m_name, $m_sex, $prof_pic, $m_dept, $m_faculty, $userMail, 
							...
							$mailMsg = str_replace('<br />', "\n", $njnk_msg);	
									...
									echo "<script type='text/javascript'> $('#mailTopTitle').html('View My Companion Draft Message');
																		  $('#mailTitleHolder').html('View My Companion Draft Message');</script>";
