     ...
     define('wizGrade', 'igweze');  /* define a check for wrong access of file */
		...
		try {
				...
				if($userMail == '-'){
					...
					$myMail = '<a data-toggle="modal" href="#wizGrade-modal-mail"><button type="button" class="btn mail-btn">
					<i class="fa fa-envelope"></i> Get Email Address </button></a>';
				
				}else{
				
					$wizGradeMail = $userMail.'@wizgrade.com';
					$myMail = "<button type='button' class='btn mail-btn'> <i class='fa fa-envelope'></i> $wizGradeMail </button>";
					...
					<div class="col-sm-12">
                      <section class="panel">
                          <header class="panel-heading">
                             <i class="fa fa-comments-o fa-lg"></i> Companion Message Box
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								  ...
								  type="button"> Save Email Adresss</button>
							</div>
						</div>
					</div>
				</div>
