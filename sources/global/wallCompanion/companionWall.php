...
session_id();
			...
			if($userMail == '-'){
				...
				<i class="fa fa-envelope"></i> Get Email Address </button></a>';
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="panel-body wizGrade-line"> 
						<div class="col-md-8" >
							<section class="panel" style="border: 1px solid #FFE4C4 !important;border-radius: 30px 30px 0px 0px;
							-webkit-border-radius: 30px 30px 0px 0px;">
								...
								<hr style="border-top: 1px solid #FFE4C4 !important;" />
								...
								<button type="button" class="btn btn-white"><i class="fa fa-home"></i> Home </button></a>
								<a href="javascript:;" class="showcompanionWallUser fb-top-btn" 
								<?php echo 'id="companionWallUser-'.$member_id.'">'; ?>											  
								<button type="button" class="btn btn-white"><i class="fa fa-user"></i> My Wall </button></a>
								<a data-toggle="modal" href="#wizGrade-modal-filter" class="fb-top-btn">
								<button type="button" class="btn btn-white
								cWallSettings"><i class="fa fa-wrench"></i> Settings </button></a>
								</div>
								</div>
							</section>

							<section class="panel profile-info" style="background: #FFE4C4 !important;border-radius: 15px;
							-webkit-border-radius: 15px;">
								...
								<div id="wallMsgDiv">
									...
									<form method="POST" id="frmPost" class="highlight-textarea">
										...
										<textarea class="form-control input-lg p-text-area" style="border: 3px solid #FFE4C4 !important;" 
								...
								<footer class="panel-footer" style="background: #FFE4C4 !important;">
