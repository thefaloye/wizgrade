...
IGWEZE;
		...
		function wizGradeCalendar($month, $year){  /* auto generated calendar */
...
END;
		...
		function wizGradeMailer($to, $subject, $message, $from) {  /* wizGrade Mailer */
						
			$headers ="From: wizGrade School App <info@wizgrade.com>\n";
