...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This page load pending library books application
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */ 
...
?> 		
					...
					<div class="row">  
     				  <div class="col-lg-6">
                      <section class="panel wizGradeSectionDiv" id="scrollLTarget">
                      
                          <header class="panel-heading">
                            <i class="fa fa-eye fa-lg"></i>  Pending Book Applications
							...
							<div class="btn-group">
								...
								<i class="fa fa-wrench"></i> <span class="caret"></span></button>
									<ul role="menu" class="dropdown-menu pull-right">
											<li>
											<a href='javascript:;' id ="$applyID" class ='show-pending-book-info'><button class="btn btn-success btn-xs">
											<i class="fa fa-th-large"></i></button> Approve/Discard</a>
											</li>
											<li class="divider"></li>
											<li>
...
IGWEZE;
					...
					$msg_i = "Oooooooops, no library pending book was found.";
...
?>
						...
						<div class="col-lg-6">
							<section class="panel" id="scrollLTarget-t">
								...
								<header class="panel-heading">
									<i class="fa fa-wrench fa-lg"></i> Library Book Application Info
									<span class="tools pull-right">
										<a href="javascript:;" class="fa fa-chevron-down"></a>
										<a href="javascript:;" class="fa fa-times"></a>
									</span>
