...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This script handle expense category
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
?>				
		<!-- row -->
			...
			<div class="col-sm-12">
				...
				<header class="panel-heading">
					<i class="fa fa-wrench fa-lg"></i> Expense Category Manager
				...
				<div class="panel-body wizGrade-line"> 
					...
					<header class="panel-heading tab-bg-dark-navy-blue" id="scrollTarget">
						<ul class="nav nav-tabs nav-justified">
							<li class="active">
							<a data-toggle="tab" href="#viewExpenseCategory">
							...
							<li>
							<a data-toggle="tab" href="#addExpenseCategory">
					...
					<div class="panel-body">
						...
						<div class="tab-content">
							<div id="viewExpenseCategory" class="tab-pane active"> <?php require 'expenseCategoryInfo.php';  ?> </div> 

							<div id="addExpenseCategory" class="tab-pane">
					...
					<div class="row">  
									...
									<!-- form --><form class="form-horizontal" id="frmsaveExpenseCategory" role="form"> 
										...
										<div class="form-group">
											<input type="hidden" name="expenseCategoryData" value="expenseCategoryConfigs" />
											<center><button type="submit" class="btn btn-danger buttonMargin" id="saveExpenseCategory">
											<i class="fa fa-save"></i> Save Expense </button></center>
		...
		<!-- expense category removal pop up modal start -->
		...
		<div class="modal fade" id="removeModal" tabindex="-1" role="dialog"  aria-labelledby="wizGrade-modalLabel" aria-hidden="true">
			<div class="modal-dialog">
				...
				<h4 class="modal-title"> Are sure you want to remove this expenseCategory information ?
				</h4>
				</div>
				...
				<div class="modal-footer slideUpFrmDiv">
					<button  class="btn btn-danger demoDisenable" id="removeExpenseCategory" 
		...
		<!-- expense category removal pop up modal end -->


		<!-- expense category edit pop up modal start -->
		...
		<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="wizGrade-modalLabel" aria-hidden="true">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					data-dismiss="modal" aria-hidden="true">
					<span style='color:#fff !important;'>&times;</span></button>
					<h4 class="modal-title"> ExpenseCategory Information Management </h4>
				</div>
				<div class="modal-body"> 
					...
					<section class="panel">
						...
						<div class="panel-body"> 
							...
							<div id="editExpenseCategoryDiv"></div> 
		...
		<!-- expense category edit pop up modal end --> 