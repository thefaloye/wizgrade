...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This page is the staff change password manager
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */ 
...
?> 
					...
					<div class="row">  
						...
						<section class="panel wizGradeSectionDiv">                      	
							...
							<!-- form -->
                            <!-- form --><form class="form-horizontal" id="frmchangeSPass" role="form">                              
                                ...
                                <div class="form-group">
                                      ...
                                      <div class="col-lg-8">
                                          <div class="iconic-input">
                                              <i class="fa fa-key"></i>
                                              <input type="password" class="form-control" 
                                              name="confirm_new" id="confirm_new" />
                                          </div>
                                      </div>
                                </div> 

                                <div class="form-group">                                      
                                        <input type="hidden" name="staffPass" value="changePass" />
                                        <center><button type="submit" class="btn btn-danger buttonMargin demoDisenable" id="changeSPass">                                          
