...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This script load all class result
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */ 
					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">
								...
								<i class="fa fa-check-square-o fa-lg"></i> Class Session Result Manager
...
IGWEZE;
			...
			$top_cols = (($stop_njideka * 2) + 8);
			$sortCol = (($stop_njideka * 2) + 3); 

$table_head =<<<IGWEZE

		<!-- table -->
		<table cellpadding="0" cellspacing="0" border="0" class="display compact table-bordered 
		table-striped table-hover" id="wizGradePageTB" width="100%">
			<thead>
			...
			<tr> 
				<td colspan = "$top_cols"> 
				<center>$stu_class $class Class - $term_value</center>
...
IGWEZE;
			...
			if(($query_i_strings_nk != "") ){				
				...
				if($rows_count_1 >= $foreal) {  /* check array is empty */
					...
					//<th><div class='vertical'>S/N</th> 

					echo  "<tr class='grade'> 
					
					<th> <div class='vertical'> Reg. No.</div></th> 
					
					<th align = 'left' width='15%'><div class='vertical'>Name (Class)</div></th> ";

					for ($i = $start_nkiru; $i <= $stop_njideka; $i++) {  /* loop array */
						
						$top_course = substr($course_info_mark[$i][2], 0, 20);
						
						echo "<th align = 'center' class='sort-numeric' ><div class='vertical'>";
						echo $top_course;
						echo "</div></th>"; 
          			...
          			echo" <th class='sort-numeric vertical'><div class='vertical' id='rs_bgcolo_gr'>CLASS POSITION
					</div></th>";
          			echo" <th class='vertical' id='scrollToTarget'><div class='vertical'>TASK</div></th>";
          			echo  "</tr> </thead><tbody>";
					...
					while($row[] = $igweze_prep->fetch(PDO::FETCH_BOTH)) {  /* loop array */ 
						...
						//echo "<td align = 'center'> $serial_no </td>"; 
       					...
       					for ($i = $inti_reg_no_arr; $i <= $inti_reg_no_arr; $i++) {  /* loop array */
							...
							$studentClass = studentClass($conn, $regNum, $level);  /* students class information  */
							echo "<td style='text-align:center; text-transform:uppercase; font-size:12px; font-weight:700;'>";
	   						echo $pre_regnum.$regNum;
       						echo "</td>"; 
							
							echo "<td style='text-align:left !important; padding-left: 3px !important;width:15% !important;'>";
	   						echo "<span style='text-align:left; text-transform:uppercase; font-size:11px; font-weight:700;'>
							<img src = '$stuPic' height = '25' width = '25' class='small-picture'> $stuData </span>  ($studentClass)";
       						echo "</td>";
