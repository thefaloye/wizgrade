...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This page is the bulk excel  subject comment manager
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */ 
					...
					<div class="row">  
						...
						<section class="panel wizGradeSectionDiv">
							<header class="panel-heading">                             
								<i class="fa fa-commenting-o fa-lg"></i> Bulk Excel   Subject Comment 
							...
							<!-- form -->
							<!-- form --><form class="form-horizontal" id = "frmbulkSubComExcel"  enctype="multipart/form-data" 
							action='wizGradeBulkSubCom.php' role="form">
							...
							<?php if ($admin_grade == $staffGrade) {  /*  check if school staff */ ?>
								...
								<div class="form-group">
                                          ...
                                          <div class="controls col-lg-8 col-ms-8">
                                              <div class="fileupload fileupload-new" data-provides="fileupload">
                                                ...
                                                <input type="file" class="default" name="bulkExcel" id="bulkSubComExcel" />
                                                </span>
								...
								<input type="hidden" name="rsData" value="bulkSubComm" /> 
						...
						<section class="panel wizGradeSectionDiv">
							<header class="panel-heading">                             
								<i class="fa fa-info-circle fa-lg"></i> Bulk Subject  Format
								<span class="tools pull-right">
									<a href="javascript:;" class="fa fa-chevron-down"></a>
									<a href="javascript:;" class="fa fa-times"></a>
								</span>
							...
							<span class="text-info"> <a  href="javascript:;" id="exportResult-ft">Export Result Format</a></span>
							</button>
							
							<button  class="btn btn-white pull-right" onclick="window.open('bulkComExample.xls')">
							<i class="fa fa-cloud-download text-info"></i> 
