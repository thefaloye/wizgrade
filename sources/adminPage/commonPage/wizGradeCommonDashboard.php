...
?>
			...
			<!-- row -->
             ...
             <!-- / row -->	
			  ...
			  <div class="col-lg-12 col-md-12">
                  <div class="panel">
                      <div class="panel-heading">
                         <i class="fa fa-area-chart fa-lg"></i> School Population Summary
                          <span class="tools pull-right">
                                <a href="javascript:;" class="fa fa-chevron-down"></a>
                                <a href="javascript:;" class="fa fa-times"></a>
                            </span>
                  ...
                  <div class="col-lg-4 col-lg-6">
                      <section class="panel value-box-cell">
                       ...
                       <center><button  class="btn btn-white changeSchool" style="margin-bottom:30px;" id="log-nur">
                  ...
                  <div class="col-lg-4 col-lg-6">
                      <section class="panel value-box-cell">
                       ...
                       <center><button  class="btn btn-white changeSchool" style="margin-bottom:30px;" id="log-pri">
                  ...
                  <div class="col-lg-4 col-lg-6">
                      ...
                      <center><button  class="btn btn-white changeSchool" style="margin-bottom:10px;" id="log-sec">
            ...
            <!-- / row -->	
			  ...
			  <div class="col-lg-12 col-md-12">
                  <div class="panel">
                      <div class="panel-heading">
                         <i class="fa fa-bar-chart fa-lg"></i> Nursery School  Summary 
                          <span class="tools pull-right">
                                <a href="javascript:;" class="fa fa-chevron-down"></a>
                                <a href="javascript:;" class="fa fa-times"></a>
                            </span>
             ...
             <!-- nursery school div end -->
			  ...
			  <div class="col-lg-12 col-md-12">
                  <div class="panel">
                      <div class="panel-heading">
                       <i class="fa fa-line-chart fa-lg"></i> Primary School  Summary 
                          <span class="tools pull-right">
                                <a href="javascript:;" class="fa fa-chevron-down"></a>
                                <a href="javascript:;" class="fa fa-times"></a>
                            </span>
             ...
             <!-- primary school div end --> 
			  ...
			  <div class="col-lg-12 col-md-12">
                  <div class="panel">
                      <div class="panel-heading">
                         <i class="fa fa-area-chart fa-lg"></i> Secondary School  Summary 
                          <span class="tools pull-right">
                                <a href="javascript:;" class="fa fa-chevron-down"></a>
                                <a href="javascript:;" class="fa fa-times"></a>
                            </span>
