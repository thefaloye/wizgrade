...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This page export class result to excel format
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */ 
					...
					<div class="row">  
						...
						<section class="panel wizGradeSectionDiv">
							<header class="panel-heading">                             
								<i class="fa fa-file-excel-o fa-lg"></i>  Export Class Results
							...
							<!-- form -->
							<!-- form --><form class="form-horizontal" id="frmload-exportRS" role="form">
							...
							<?php if ($admin_grade == $staffGrade) {  /*  check if school staff */ ?>
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
											<div class="iconic-input">
												...
												<input type="hidden" value="exportRS" name = "searchData"/>
                                ...
                                <div class="form-group">
                                        <center><button type="submit" class="btn btn-danger buttonMargin" id="load-exportRS">
                                        <i class="fa fa-search-plus"></i> Search  Results </button></center>
                                </div>  
