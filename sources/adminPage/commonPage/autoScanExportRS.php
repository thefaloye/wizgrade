...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This page is the export auto scaning class results manager
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */ 
					...
					<div class="row">  					
						...
						<section class="panel wizGradeSectionDiv">
							<header class="panel-heading">                              
							  <i class="fa fa-file-excel-o fa-lg"></i> Export Class Auto Scaning Results
							...
							<!-- form -->
							<!-- form --><form class="form-horizontal" id="frmexAutoScanRS" role="form">
							...
							<?php if ($admin_grade == $staffGrade) {  /*  check if school staff */ ?>
    							...
    							<span id="result_1" style="display: none;"></span> <!-- loading div -->  <!-- jquery loading div -->
                                 ...
                                 <div class="form-group">
										<input type="hidden" value="exportScanRS" name = "searchData"/>
										<input type="hidden" value="<?php echo $blankStatus; ?>" name = "blank"/>	
                                        <center><button type="submit" class="btn btn-danger buttonMargin" id="exAutoScanRS">
