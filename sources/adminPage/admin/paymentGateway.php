...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This page is the payment gateways manager
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */ 
...
?> 
					...
					<div class="col-lg-12">
						<section class="panel">
							<header class="panel-heading">
                             <i class="fa fa-wrench fa-lg"></i> Payment Gateway Manager
							...
							<div class="panel-body wizGrade-line"> 
								...
								<div id="viewPayGateway" class="tab-pane active"> 
								<?php require 'paymentGatewayInfo.php';   /* include gateways information page */   ?> </div> 				
				...
				<!-- / row -->	
							<!-- payment gateways removal pop up modal start -->
							...
							aria-labelledby="wizGrade-modalLabel" aria-hidden="true">
                                      ...
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              ...
                                              <h4 class="modal-api"> Are sure you want to remove this Payment Gateway information ?
											  </h4>
                                          </div>
                                          ...
                                          <div class="modal-footer slideUpFrmDiv">
                                              <button  class="btn btn-danger" id="removePayGateway" 
							...
							<!-- payment gateways removal pop up modal end -->  
							  
							<!-- payment gateways tasks pop up modal start -->  
                                  ...
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          <div class="modal-header">
                                              ...
                                              data-dismiss="modal" aria-hidden="true">
											  <span style='color:#fff !important;'>&times;</span></button>
                                              <h4 class="modal-api"> Payment Gateway Manager
											  </h4>
                                          </div>
							...
							<!-- payment gateways tasks pop up modal end -->   