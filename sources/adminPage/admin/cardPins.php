					...
					<div class="col-sm-10">
						<section class="panel">
							<header class="panel-heading">                              
								<i class="fa fa-paw fa-lg"></i> Scratch Card Pin Manager
											...
											<div id="addCardPin" class="tab-pane"> 
												...
												<div class="row">  
													...
													<div class="form-group">									  
														...
														<i class="fa fa-save"></i> Generate Card Pins </button></center>
					...
					<div class="modal-dialog">
					  <div class="modal-content">
						  <div class="modal-header">
							  ...
							  data-dismiss="modal" aria-hidden="true">
							  <span style='color:#fff !important;'>&times;</span></button>
							  <h4 class="modal-iiii_pin_iiii"> Scratch Card Pin  Manager
							  </h4>
						  </div>
