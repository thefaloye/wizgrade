					...
					<div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
							...
							<i class="fa fa-university fa-lg"></i> School Hostel Manager
									  ...
									  <div class="tab-content">
										...
										<div id="addHostel" class="tab-pane">
											...
											<div class="col-lg-12"> 
												...
												<br clear="all" /> <center><img src="loading.gif" alt="Page Loading >>>>>" id="saveLoader"  
												...
												<div id="hmsgBox"> </div>
												  ...
												  <div class="col-lg-7">
													...
													<div class="form-group">
													  ...
													  <i class="fa fa-save"></i> Save Hostel </button></center>
