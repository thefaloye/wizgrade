            ...
            <div class="col-lg-5">
                    <section class="panel">
						<header class="panel-heading">                              
							  <i class="fa fa-search-plus fa-lg"></i> Staff Profile Search 
...
$table_ed =<<<IGWEZE
										...
										<a href='javascript:;' id='$t_id' class ='viewStaff'> <img src = '$teacherPic' height = '40' 
...
?>
			...
			<div class="col-lg-7">
				<section class="panel" id="wizGradeScrollTarget">
					...
					<header class="panel-heading">
						<i class="fa fa-wrench fa-lg"></i> Staff Bio Tasks Panel
						<span class="tools pull-right">
						<a href="javascript:;" class="fa fa-chevron-down"></a>
						<a href="javascript:;" class="fa fa-times"></a>
						</span>
