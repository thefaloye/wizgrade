	...
	<section id="container" >
		...
		<header class="header top-header-bg">
			...
			<div class="top-nav top-school-info"> 
				...
				<span id="top-school-name"><?php echo substr($schoolNameTop, 0, 38); ?></span> (<?php echo $schoolTypeSD; ?>)
					...
					<li class="dropdown pull-right">
						...
						<li class="sub-menu">
						  ...
						  <ul class="sub">
							  ...
							  <i class="fa fa-chevron-right"></i> Manage Exam/s</a></li> 
						...
						<li class="sub-menu">
						  ...
						  <ul class="sub">
							  ...
							  <i class="fa fa-chevron-right"></i> Manage Assign./s</a></li> 
						  </ul>
						</li>
								...
								<div class="navbar-footer-content">
									<div class="row">
										<div class="col-md-6 wizGradeMenu">
											<a href="javascript:;" id="editAccess" 
		...
		<section id="main-content">
			<section class="wrapper site-min-height" id="scrollTargetMPage" > 
				...
				<div id='wizGradePageContent' style="margin-top:0px; margin-bottom: 30px;">  
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body modal-body-scroll"> 
						...
						<center><img src="loading.gif" alt="Page Loading >>>>>" id="studentSLoading"  
