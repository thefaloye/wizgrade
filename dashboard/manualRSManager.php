...
$table_head =<<<IGWEZE
					...
					<!-- table -->
					<table width = '100%' border = '0' align = 'center' class="table table-striped table-advance table-hover" id="wizGradePageTB">
                          ...
                          <strong><?php echo "$session_fi $session_se session ";
                              ...
                              <?php 
							  	...
							  	/*echo'
									...
									class="tooltip-hide tooltips Stooltips showRSConfigDiv" data-toggle="tooltip" data-placement="top" 
