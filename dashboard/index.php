                ...
                <ul class="nav pull-right top-menu">  
                    ...
                    <li class="dropdown" style=" ">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="javascript:;">
                             <img alt="" src="<?php echo $userPicture; ?>" height="37" width="40" class="img-circle"> 
                            <b class="caret"></b>
                        </a> 
						...
						<li>
								...
								<div class="row">
									<div class="col-md-5">
										...
										height="120px" width="120px" class="img-circle" />
										 <p class="text-center small wizGradeMenu1"></p>		
									...
									<div class="col-md-7 wizGradeMenu1">
										...
										<div class="divider">
										 ...
										 <a href="javascript:;" id="<?php echo $showBioID; ?>" 
							...
							<div class="navbar-footer">
								<div class="navbar-footer-content">
									<div class="row">
										<div class="col-md-6 wizGradeMenu1">
											<a href="javascript:;" id="<?php echo $changePassID; ?>" 
			...
			<div class="nav notify-row" >		
                ...
                <ul class="nav top-menu"> 
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended dropdown-scroll inbox pull-right">
			...
			<section class="wrapper site-min-height" id="scrollTargetMPage" > 
				...
				<div class="panel-body">
					...
					<div class="btn-group btn-group-justified">
						  ...
						  <i class="fa fa-sign-in fa-lg"></i> <span class="middle-menu-div">Go To </span> Secondary
						  ...
						  <i class="fa fa-sign-in fa-lg"></i> <span class="middle-menu-div">Go To </span> Primary 
						  <span class="hide-res">School</span> <span class="middle-menu-div">Section</span></a>
						  <a class="btn btn-danger changeSchool" id="log-nur" href="javascript:;">
						  <i class="fa fa-sign-in fa-lg"></i> <span class="middle-menu-div">Go To </span> Nursery 
						  <span class="hide-res">School</span> <span class="middle-menu-div">Section</span> </a>
					</div>
					</div> 
