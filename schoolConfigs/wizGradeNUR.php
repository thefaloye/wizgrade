...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This script load nursey school configurations
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
		...
		$schoolID = $fiVal;		$schoolTBPref = $wizGradeNurPref;	  
		$supRegNo = $schoolRegSuffArr[$schoolID];   
		$schoolPicDir = $wizGradePicDir.'nursery/'; global $schoolPicDir;		  		  
		$wizGradeConfigTB = $wizGradeDB.'.wizgrade_config_nur'; global $wizGradeConfigTB;
		...
		for ($i = $i_fi_start_class_one_fi_term; $i <= $i_fi_last_class_one_fi_term; $i++){ 
		...
		for ($i = $i_se_start_class_one_se_term; $i <= $i_se_last_class_one_se_term; $i++){ 
		...
		for ($i = $i_th_start_class_one_th_term; $i <= $i_th_last_class_one_th_term; $i++){ 
		...
		for ($i = $i_gr_start_class_one; $i <= $i_gr_last_class_one; $i++){
