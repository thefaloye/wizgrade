...
session_start(); 
		...
		try {
			...
			$unreadMsg = numOfUnreadMsg($conn, $member_id);  /* number of unread message */
...
?>	
			...
			<div class="lock-div">
				...
				<!-- form --><form method="post"   role="form" class="text-center m-t-20" id="frmTimeOut">
					...
					<div class="text-right wizGradeMenu">
						<a href="javascript:;" class="text-muted">Not <?php echo $stuFullName; ?> ?  <a href="javascript:;" id="wizGradeLogOuta">
		...
		<header class="header top-header-bg">
			...
			<div class="nav notify-row dropdown-menu-top">
				...
				<ul class="nav  top-menu nav-top-accordion">  
					<li class="dropdown pull-right">
						...
						<li class="wizGradeMenu">
						  <a class="tpMenu"  href="javascript:;" id="wizGradeExam" >
							  <i class="fa fa-check-square-o"></i>
						...
						<li class="wizGradeMenu">
						  <a class="tpMenu"  href="javascript:;" id="wizGradeHomework" >
						...
						<li class="sub-menu">
						  ...
						  <ul class="sub">
							  <li class="wizGradeMenu"><a  class="tpMenu"  href="javascript:;" id="schoolLibrary">
							  <i class="fa fa-chevron-right"></i> View  Books</a></li>	
							   
							  <li class="wizGradeMenu"><a  class="tpMenu"  href="javascript:;" id="libraryHistory">
							  <i class="fa fa-chevron-right"></i> My Lib. History</a></li>
						...
						<li class="wizGradeMenu">
						  <a class="tpMenu"  href="javascript:;" id="supportDesk">
								...
								<div class="row">
									<div class="col-md-5">
										...
										height="120px" width="120px" class="img-circle" />
										 <p class="text-center small wizGradeMenu">
											<a href="javascript:;" id="supportDesk">Need Help ?</a></p>		
			...
			<div class="nav notify-row">
                ...
                <ul class="nav top-menu"> 
                    ...
                    <li id="header_inbox_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended inbox dropdown-scroll pull-right">
                    ...
                    <li id="header_notification_bar" class="dropdown">
                        ...
                        <ul class="dropdown-menu extended notification dropdown-scroll pull-right">
			...
			<div class="nav notify-row dropdown-menu-notification" id="top_menu">
                <!--  tasks button  start-->
                <ul class="nav top-menu">
					
					<!-- refresh page start -->
                    <li id="header_refresh_bar" class="dropdown pageRefresh dropdown">
                        <a data-toggle="dropdown" class="btn btn-danger dropdown-toggle" href="javascript:;">
                    ...
                    <!-- refresh page end -->
                     ...
                     <!-- lock screen start -->
                    <li id="header_lock_bar" class="dropdown lockScreen wizGradeMenu1">
		...
		<aside>
			<div id="sidebar"  class="nav-collapse mCustomScrollbar-O">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<li class="wizGradeMenu">
					  <a href="javascript:;" id="wizGradeExam" >
						  <i class="fa fa-check-square-o"></i>
						  <span>Online Examination </span>
					  </a>
					...
					<li class="wizGradeMenu">
					  <a href="javascript:;" id="wizGradeHomework" >
						  <i class="fa fa-cubes"></i>
						  <span>School Assignment </span>
					  </a>
					...
					<li class="sub-menu">
					  ...
					  <ul class="sub">
						  <li class="wizGradeMenu"><a  href="javascript:;" id="schoolLibrary">
						  <i class="fa fa-chevron-right"></i> View  Books</a></li>	
						   
						  <li class="wizGradeMenu"><a  href="javascript:;" id="libraryHistory">
						  <i class="fa fa-chevron-right"></i> My Lib. History</a></li>
					...
					<li class="wizGradeMenu">
					  <a href="javascript:;" id="supportDesk">
						  <i class="fa fa-question-circle-o"></i>
						  <span>Help Desks</span>
					  </a>
