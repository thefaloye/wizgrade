...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
			...
			$checkfiBouncerBabe = 'IFabuLOUSlyLoveNJideka'.$regID.'_'.$njidekaBouncerRand.'_Fabulous_Mum_In_the_GloBE';

			$checkseBouncerBabe = 'IFabuLOUSlyLoveNKiruKa'.$regNum.'_'.$nkirukaBouncerRand.'_FabUloUS_Wife_In_the_WorlD';
			...
			try {
				...
				if($schoolID == $fiVal) { $schoolHead = $nurseryHead; $schoolExt = $wizGradeNurAbr;}
				elseif($schoolID == $seVal) { $schoolHead = $primaryHead; $schoolExt = $wizGradePriAbr;}
				elseif($schoolID == $thVal) { $schoolHead = $secondaryHead; $schoolExt = $wizGradeSecAbr; }
				else { $schoolHead = "";$msg_e = "*Ooooooops, a critcal error has Occured, Please contact the developers. Error 411";
				...
				$simplePayPublicKey = trim($gatewayPaymentDataArr[$thVal]["gateKey"]);
