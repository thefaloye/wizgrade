...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This script handle no javascript by user browser
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
	...
	<body class="body-404">
		...
		<div class="container">
			...
			<section class="error-wrapper text-center">
				...
				<h1>No  Scripts</h1>
				<h2>Ooooooooops, you need to turn on your javascript in your web browser to access this web application. Thanks
		  
				<br /> <br /><a href="javascript:;" onclick='window.history.go(-1); return false;' >Go Back</a></h2>
