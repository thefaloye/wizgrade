		...
		<!-- page start--> 
			...
			<section class="panel col-lg-2"></section>
				...
				<header class="panel-heading"> 
					<i class="fa fa-user-plus fa-lg"></i> <?php echo $schoolNameTop ?> - Online Registration Form
				...
				style="cursor:pointer; display:none; margin-bottom:5px;" /> </center>
					...
					<form enctype="multipart/form-data" class="form-horizontal frmsaveReg" id="wizardfrm" 
						method="POST" action="onlineRegManager.php">
						...
						<i class="fa fa-save"></i> Submit Registration </button>
					</form>
					<span class="col-i-1">wizGrade</span>	
					<!-- form -->
