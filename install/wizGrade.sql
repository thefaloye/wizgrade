...
CREATE TABLE `nur_wizgrade_class_one_grade` (
  `id_pfi` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
  `certify` enum('0','1') NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_pfi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `nur_wizgrade_class_one_grand_score` (
  `id_gfi` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `nur_wizgrade_class_one_remark` (
  `id_remark` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
...
CREATE TABLE `nur_wizgrade_class_one_score` (
  `id_fi` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
  `certify` enum('0','1') NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_fi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `nur_wizgrade_class_one_sub_score` (
  `id_sfi` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
...
CREATE TABLE `nur_wizgrade_class_three_grade` (
  `id_pse` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
  `certify` enum('0','1') NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_pse`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `nur_wizgrade_class_three_grand_score` (
  `id_gth` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) DEFAULT NULL,
...
CREATE TABLE `nur_wizgrade_class_three_score` (
  `id_th` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
  `certify` enum('0','1') NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_th`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `nur_wizgrade_class_three_sub_score` (
  `id_sth` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
  `CF` enum('0','1') NOT NULL DEFAULT '1',
  `CS` enum('0','1') NOT NULL DEFAULT '1',
  `CT` enum('0','1') NOT NULL DEFAULT '1',
...
CREATE TABLE `nur_wizgrade_class_two_grand_score` (
  `id_gse` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) DEFAULT NULL,
...
CREATE TABLE `nur_wizgrade_class_two_score` (
  `id_se` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
  `certify` enum('0','1') NOT NULL DEFAULT '1',
  PRIMARY KEY (`id_se`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `nur_wizgrade_class_two_sub_score` (
  `id_sse` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
  `CF` enum('0','1') NOT NULL DEFAULT '1',
  `CS` enum('0','1') NOT NULL DEFAULT '1',
  `CT` enum('0','1') NOT NULL DEFAULT '1',
...
CREATE TABLE `nur_wizgrade_exams_config` (
  `ex_id` tinyint(3) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `nur_wizgrade_hostel` (
  `h_id` smallint(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `nur_wizgrade_jss_class_repeat` (
  `id_jrp` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
...
CREATE TABLE `nur_wizgrade_regno` (
  `ireg_id` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `nur_wizgrade_sss_class_repeat` (
  `id_srp` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) NOT NULL,
  `level` enum('1','2','3') NOT NULL DEFAULT '1',
  `scores` text NOT NULL,
  `sub_scores` text NOT NULL,
...
CREATE TABLE `pri_wizgrade_class_five_grand_score` (
  `id_gfo` int(10) NOT NULL AUTO_INCREMENT,
  `ireg_id` int(10) DEFAULT NULL,
...
CREATE TABLE `wizgrade_bursary` (
  `b_id` tinyint(3) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `wizgrade_club` (
  `club_id` int(3) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `wizgrade_cw_ireport` (
  `report_id_idgsi` int(10) NOT NULL AUTO_INCREMENT,
  `comment_id_idgsi` int(10) NOT NULL DEFAULT '0',
  `article_id_idgsi` int(10) NOT NULL DEFAULT '0',
  `report_idgsi` text NOT NULL,
  `reporting_user_idgsi` int(10) NOT NULL DEFAULT '0',
  `reported_user_idgsi` int(10) NOT NULL DEFAULT '0',
  `date_idgsi` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`report_id_idgsi`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `wizgrade_disability` (
  `id_dis` int(3) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `wizgrade_ewallet_nkiruka` (
  `iiii_id` int(10) NOT NULL AUTO_INCREMENT,
...
(3, 'SimplePay', 'Simple Pay Public Key', 'test_pu_51bb1038d4a846e398df210086d117ae'),
...
CREATE TABLE `wizgrade_remarks` (
  `id_rem` int(3) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `wizgrade_route` (
  `r_id` smallint(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `wizgrade_schoolinfo` (
  `school_id` tinyint(3) NOT NULL AUTO_INCREMENT,
...
(1, 'wizGrade SCHOOL', '1 OSINACHI IFECHI DRIVE ABUJA', 'wizGrade', 45, '', '', '', '473C8B', 'ifechi-school-logo.png', 40, 'en/en', '', '0');
...
CREATE TABLE `wizgrade_school_fee_igweze` (
  `sfeeID` int(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `wizgrade_session` (
  `id_sess` int(3) NOT NULL AUTO_INCREMENT,
  `year` int(4) NOT NULL,
...
(16, 2015, '    ', '    ', '    ', NULL, NULL, NULL, '0', '1', '1', NULL),
...
(21, 2020, NULL, NULL, NULL, NULL, NULL, NULL, '0', '0', NULL, NULL),
...
CREATE TABLE `wizgrade_teachers_record` (
  `t_id` mediumint(10) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `wizgrade_teacher_rank` (
  `rank_id` int(3) NOT NULL AUTO_INCREMENT,
