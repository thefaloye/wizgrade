...
?>
    ...
    <link href='../wizGradeTemplates/css/bootstrap-reset-27408B.css' rel='stylesheet'>   
    ...
    <link href='../wizGradeTemplates/css/style-27408B.css' rel='stylesheet'>
...
";
			...
			if (fwrite($installFile, $newInfo) > 0 ){
				...
				<b>wizGrade School App</b> installation is 98% successfully completed!.  
				<a href='$wizGradeInstallDir'  target='_top'><b>
				Please click here complete installation and delete installation files</b></a>.";
				echo $succMsg.$msg_s.$msgEnd; 
				
			}else{

				$msg_i = "<i class='fa fa-check fa-3x pull-left'></i> <span class='sr-only'>Loading...</span>
				<b>wizGrade School App</b> installation is 98% successfully completed!. However, some files were unable to delete due
				to your files permission. Please manually delete the install folder. 
			...
			<b>wizGrade School App</b> installation is currently running. 
			Please, don't disconnect your network or shut down your system. <br /><br /> Please wait . . . . $remaingPer";
			echo $infMsg.$msg_i.$msgEnd;
