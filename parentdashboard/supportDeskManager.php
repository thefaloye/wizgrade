     ...
     define('wizGrade', 'igweze');  /* define a check for wrong access of file */
		...
		if (($_REQUEST['msgData']) == 'support') {
			...
			try {
					...
					$recepID = adminWallCmailID($conn, $msgRecep);  /* admin ID */ 
					...
					if($msgRecep == ''){
						...
						$msg_e = "Ooooooooops, this admin can't receive mail for the moment. Thanks"; 
						echo $errorMsg.$msg_e.$eEnd; 
						echo "<script type='text/javascript'> $('.alert').fadeOut(15000); hidePageLoader();  /* hide page loader */	</script>"; exit;					
											
					}elseif ($msgTitle == '') { 
					
						$msg_e = "Ooooooooops, please type your title"; 
						echo $errorMsg.$msg_e.$eEnd; 
						echo "<script type='text/javascript'> $('.alert').fadeOut(15000); hidePageLoader();  /* hide page loader */	</script>"; exit;					
											
					}elseif ($mailMsg == '') { 
					
						$msg_e = "Ooooooooops, please type your message"; 
						echo $errorMsg.$msg_e.$eEnd; 
						echo "<script type='text/javascript'> $('.alert').fadeOut(15000); hidePageLoader();  /* hide page loader */	</script>"; exit;					
