						...
						<div class="col-lg-12">
							  ...
							  <section class="panel">
								  ...
								  <div class="panel-footer exam-foot">
										<ul>
										<section style="padding:15px !important; font-size:14px; font-weight:700;">
						  ...
						  <div class="topQuestDiv">
							...
							<div class="assignQuestionDiv" id="assignQuestionDiv">
								...
								<div class="panel-body" style="clear:both;">
									...
									<center>
									<button type="button" class="btn btn-success" id="reviewQuest"><i class="fa fa-eye"></i> Review Later </button>
