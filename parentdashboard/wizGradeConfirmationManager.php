...
/*  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 	
	...
	This script handle check out confirmation page
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
...
session_start();
     ...
     define('wizGrade', 'igweze');  /* define a check for wrong access of file */
		...
		if (($_REQUEST['shopData'] == 'confirmation') && ($_REQUEST['confirm'] == 'bankDeposit')){
			
			$paymentStatus = $fiVal;	
			require 'wizGradeConfrimationPage.php';  /* inludes confirmation page */
