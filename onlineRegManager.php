	...
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */
		...
		if (($_REQUEST['registration']) == 'onlineReg') {
			...
			if ($school == "")  {
				...
				<span style = 'color:#000'> Error in Step 1 </span>";
				...
				$msg_e = "Oooooooops error, please select student' s gender  - 
				<span style = 'color:#000'> Error in Step 1 </span>";
			
			}elseif ($dateofbirth == "") {
			
				$msg_e = "Oooooooops error, please enter student' s date of birth  - 
				<span style = 'color:#000'> Error in Step 1 </span>";
			
			}elseif ($bloodgr == "") {
			
				$msg_e = "Oooooooops error, please enter student' s blood group - 
				<span style = 'color:#000'> Error in Step 1 </span>";
			
			}elseif ($genotype == "") {
			
				$msg_e = "Oooooooops error, please enter student genotype - 
				<span style = 'color:#000'> Error in Step 1 </span>";
			
			}elseif (($country == "")) {
				
				$msg_e = "Oooooooops error, please select student nationality  - 
				<span style = 'color:#000'> Error in Step 2 </span>";
				
			}elseif (($state == "")) {
				
				$msg_e = "Oooooooops error, please select student state  - 
				<span style = 'color:#000'> Error in Step 2 </span>";
				
			}elseif($city == "")   {
				
				$msg_e = "Oooooooops error, please enter student city  - 
				<span style = 'color:#000'> Error in Step 2 </span>";
				
			}elseif($add1 == "") {
				
				$msg_e = "Oooooooops error, please enter student parmanent address  - 
				<span style = 'color:#000'> Error in Step 2 </span>";
				
			}elseif($sponsor == "")   {
				
				$msg_e = "Oooooooops error, please enter student' s sponsor name  - 
				<span style = 'color:#000'> Error in Step 3</span>";
				
			}elseif($sponphone == "")   {
				
				$msg_e = "Oooooooops error, please enter student' s sponsor phnone no  - 
				<span style = 'color:#000'> Error in Step 3</span>";
				
			}elseif($soccup == "")   {
				
				$msg_e = "Oooooooops error, please enter student' s sponsor occupation
				<span style = 'color:#000'> Error in Step 3</span>";
				
			}elseif($sponadd == "")   {
				
				$msg_e = "Oooooooops error, please enter student' s sponsor address  - 
				<span style = 'color:#000'> Error in Step 3</span>";
						...
						if (move_uploaded_file($_FILES[$filePic]['tmp_name'], $picturePath.$uploadedPic )) { /* move uploaded file to its path */
							...
							try { 
								...
								if($igweze_prep->execute()){  /* insert picture name to database */
									...
									echo "<img src=''   height = '1' width='1'> ";
									$msg_s = "<img src = '$imgSrc' height = '40' width = '40' class='small-picture' style='margin:1px;'> 
									<span>$regName</span>,
									your online registration was successfully. Thanks";	
									echo $succMsg.$msg_s.$msgEnd;  echo $scrollUp; 	
									echo "<script type='text/javascript'>   $('.frmsaveReg').slideUp(2000); </script>";  exit;									
